...
$auth_users = array(
    'admin' => '$2y$10$FdMyErfmCrlMunoG5b.NmewAT6Q/lZL3YLKVpsLdNYV3GEAMzRBba'
);
...
$root_path = $_SERVER['DOCUMENT_ROOT']; // Railway public root

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = ''; // direct public URLs under same host
